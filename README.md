...
## 4. СКРИНШОТЫ ЭКРАНА С ПРИМЕРАМИ РАБОВОТЫ

### Скриншот 1: Главная страница "Все товары"
![Главная страница](screenshots/main_page.png)
*На главной странице отображается каталог всех товаров с системой фильтрации по цене (от/до), рейтингу, бренду и категориям. Для каждого товара показаны: название, бренд, категория, цена, количество на складе и средний рейтинг на основе отзывов.*

### Скриншот 2: Личный кабинет пользователя  
![Личный кабинет](screenshots/profile.png)
*В личном кабинете пользователь видит свою персональную информацию: имя пользователя, email, имя, фамилия, дата регистрации, последний вход. Отображается текущая корзина с товарами, их количеством и общей суммой. Доступны быстрые действия для навигации.*

### Скриншот 3: Страница "Мои заказы"
![Мои заказы](screenshots/orders.png)
*Страница показывает историю всех заказов пользователя. Для каждого заказа отображается: номер, дата создания, общая сумма, текущий статус (Новый, В обработке, Выполнен, Отменен) и информация об оплате. Доступна система фильтрации заказов.*